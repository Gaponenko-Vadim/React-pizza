...
import { removeBasket } from "../redux/slice/pizzaSlice";
...
const Basket = () => {
  ...
  if (pizzaConter.length === 0) {
    return <CartEmpty />;
  }
  return (
    <div className="container container--cart ">
      <div className="cart">
        <div onClick={() => dispatch(removeBasket())} className="cart__top">
        ...
        <div className="cart__bottom">
          <div className="cart__bottom-details">
            <span>
              Всего пицц: <b>{sumPizza}</b>
            </span>
            <span>
              Сумма заказа: <b>{prices}</b>
            </span>
          </div>
